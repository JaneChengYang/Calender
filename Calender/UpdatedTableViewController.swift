//
//  UpdatedTableViewController.swift
//  Calender
//
...
class UpdatedTableViewController: UITableViewController {
    //label和text
    ...
    @IBAction func myButton(_ sender: UIButton) {
        if mySwitch.isOn == false{
            //更新
                ...
                let date = dateFormatter.date(from: myLabel.text!)
                user?.date = date
    ...
    @IBAction func antSwitch(_ sender: UISwitch) {
        if mySwitch.isOn == false{
            add()
            off()
//              breakfastText.text =  breakfastLabel.text
//              creditCardText.text = creditCardLabel.text
//              dailyText.text = dailyLabel.text
//              dinnerText.text = dinnerLabel.text
//              giftText.text = giftLabel.text
//              InvestmentText.text = InvestmentLabel.text
//              lunchText.text = lunchLabel.text
//              medicalTreatmentText.text = medicalTreatmentLabel.text
//              otherText.text = otherLabel.text
//              phoneText.text = phoneLabel.text
//              rentText.text = rentLabel.text
//              snacksText.text =  snacksLabel.text
//              socialText.text =  socialLabel.text
//              trafficText.text =  trafficLabel.text
//              total = 0
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        if let user = user{
              breakfastLabel.text = user.breakfash
              creditCardLabel.text = user.creditCard
              dailyLabel.text = user.daily
              dinnerLabel.text = user.dinner
              giftLabel.text = user.gift
              InvestmentLabel.text = user.investment
              lunchLabel.text = user.lunch
              medicalTreatmentLabel.text = user.medicalTreatment
              otherLabel.text = user.other
              phoneLabel.text =  user.phone
              rentLabel.text = user.rent
              snacksLabel.text = user.snacks
              socialLabel.text = user.social
              trafficLabel.text = user.traggic
              totalLabel.text =  "\(user.total)"
              //unwindTotal = Int(totalLabel.text!)
        }
